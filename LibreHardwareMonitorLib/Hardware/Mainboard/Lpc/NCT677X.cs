...
namespace LibreHardwareMonitor.Hardware.Lpc
{
    internal class NCT677X : ISuperIO
    {
        ...
        private bool[] _restoreDefaultFanControlRequired = new bool[6];
        private byte[] _initialFanControlMode = new byte[6];
        private byte[] _initialFanPwmCommand = new byte[6];
        ...
        public NCT677X(Chip chip, byte revision, ushort port, LPCPort lpcPort)
        {
            ...
            switch (chip)
            {
                ...
                case Chip.NCT6776F:
                    ...
                    _temperatureHalfBit = new int[] { -1, 7, 7, 7, 7, 7, 0, 1, 2 };
                ...
                case Chip.NCT6798D:
                    ...
                    _temperatureHalfBit = new int[] { -1, 7, 7, 7, 7, 7, 7 };
                ...
                case Chip.NCT610X:
                    ...
                    _temperatureHalfBit = new int[] { -1, 7, 7, 7 };
        ...
        {
            if (_chip != Chip.NCT6791D && _chip != Chip.NCT6796D && _chip != Chip.NCT6793D && _chip != Chip.NCT6795D && _chip != Chip.NCT6798D && _chip != Chip.NCT6797D)
                return;
        ...
        public void Update()
        {
            ...
            for (int i = 0; i < _voltages.Length; i++)
            {
                ...
                _voltages[i] = valid ? value : (float?)null;
            }
