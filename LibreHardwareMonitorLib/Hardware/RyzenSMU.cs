    ...
    private readonly Dictionary<uint, Dictionary<uint, SmuSensorType>> _supportedPmTableVersions = new()
    {
        ...
        },
        {
            ...
            0x00621202, new Dictionary<uint, SmuSensorType>
            {
                ...
                { 52, new SmuSensorType { Name = "VDDCR VDD", Type = SensorType.Temperature, Scale = 1 } },
                { 57, new SmuSensorType { Name = "VDDCR SoC", Type = SensorType.Temperature, Scale = 1 } },
                { 62, new SmuSensorType { Name = "VDD Misc", Type = SensorType.Temperature, Scale = 1 } },
                { 21, new SmuSensorType { Name = "SoC Power", Type = SensorType.Power, Scale = 1 } },
                ...
                { 58, new SmuSensorType { Name = "VDD Misc", Type = SensorType.Voltage, Scale = 1 } },
                { 83, new SmuSensorType { Name = "VDDCR SoC", Type = SensorType.Voltage, Scale = 1 } },
