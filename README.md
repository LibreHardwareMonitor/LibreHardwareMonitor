...
| --- | --- | --- | 
| **LibreHardwareMonitor** <br /> Windows Forms based application that presents all data in a graphical interface | .NET Framework 4.7.2 | [![Build status](https://github.com/hapnan/LibreHardwareMonitor/actions/workflows/master.yml/badge.svg)](https://github.com/hapnan/LibreHardwareMonitor/actions/workflows/master.yml) | 
